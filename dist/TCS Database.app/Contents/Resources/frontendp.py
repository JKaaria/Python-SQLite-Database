...
class Student:
    ...
    def __init__(self, root):
        ...
        Notes = StringVar()
        def iExit():
            iExit = tkinter.messagebox.askyesno("TCS Database", "Confirm if you want to exit")
        ...
        self.lblTit = Label(TitFrame, font=('times new roman', 48, 'bold'), text="TCS Database", bg="Ghost White")
